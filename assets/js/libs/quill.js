...
SnowTooltip.TEMPLATE = ['<a class="ql-preview" target="_blank" href=""></a>', '<input type="text" data-formula="e=mc^2" data-link="" data-video="Embed URL">', '<a class="ql-action"></a>', '<a class="ql-remove"></a>'].join('');
...
var Image = function (_Embed) {
  ...
  _createClass(Image, [{
    ...
    key: 'sanitize',
    value: function sanitize(url) {
      return (0, _link.sanitize)(url, ['http', 'https', 'data']) ? url : '';
    }
  }, {
    key: 'value',
    value: function value(domNode) {
...
BubbleTooltip.TEMPLATE = ['<span class="ql-tooltip-arrow"></span>', '<div class="ql-tooltip-editor">', '<input type="text" data-formula="e=mc^2" data-link="" data-video="Embed URL">', '<a class="ql-close"></a>', '</div>'].join('');

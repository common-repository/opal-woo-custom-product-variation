    ...
    !(function (e) {
        ...
        function (t, r, o) {
            ...
            const s = function (e, t = !1) {
                ...
                f = (e, t) => {
                    let r;
                    return (e = m(e)), t && (Array.isArray(t) ? (r = k(t.join(" "))) : ("boolean" == typeof t && (t = t.toString().trim()), (r = k(t)))), { name: e, value: (t = t ? `="${r}"` : "") };
                },
        ...
        function (e, t, r) {
            ...
            const o = {},
                n = { text: ["text", "password", "email", "color", "tel"], date: ['date', 'time', 'datetime-local'], header: ["h1", "h2", "h3"], button: ["button", "submit", "reset"], paragraph: ["p", "address", "blockquote", "canvas", "output"], textarea: ["textarea", "quill"] },
                i = (e) => {
        ...
        function (t, r, o) {
            ...
            n.a.register(["date", "time", "datetime-local"], h, 'date');
            n.a.register(["text", "file", "date", "number"], h), n.a.register(["text", "password", "email", "color", "tel"], h, "text");
            class g extends h {
                static get definition() {
                    return { i18n: { default: owcpv_trans_lib.fineUploader } };
                }
                configure() {
                    (this.js = [
                        this.classConfig.js || owcpv_pluin_url.plugin_url+"assets/js/libs/jquery.fine-uploader.min.js",
                    ]),
                    (this.css = [
            ...
            class x extends w {
                configure() {
                    if (((this.js = [owcpv_pluin_url.plugin_url+"assets/js/libs/tinymce.min.js"]), this.classConfig.js)) {
            ...
            class k extends w {
                configure() {
                    ...
                    Object.assign(this, C(C({}, { js: owcpv_pluin_url.plugin_url+"assets/js/libs/quill.js", css: owcpv_pluin_url.plugin_url+"assets/css/libs/quill.snow.css" }), t)), (this.editorConfig = C(C({}, e), r));
                }
                build() {
                    const e = this.config,
                        { value: t = "" } = e,
        ...
        function (t, r, o) {
            ...
            class y {
                ...
                updatePreview(t) {
                    ...
                    i.match(r.optionFieldsRegEx) &&
                        ...
                        e(".sortable-options li", n).each(function (t, r) {
                            var o = { selected: e(".option-selected", r).is(":checked"), value: e(".option-value", r).val(), label: e(".option-label", r).val() };
                            s.values.push(o);
                    ...
                    const d = h.a.lookup(s.type),
                        c = d ? d.class : b.a.getClass(s.type, s.subtype, s.radiosubtype),
                        f = this.layout.build(c, s);
                    Object(l.b)(a[0]), a[0].appendChild(f), f.dispatchEvent(u.a.fieldRendered);
                    
                    var radioGr = e(f).find('.formbuilder-radio input[type="radio"]');
                    if (radioGr.length > 0) {
                        radioGr.each(function(index) {
                            var subtype = e(this).attr('radiosubtype'),
                                parent = e(this).parents('.form-field');
                            if(subtype && !e(this).hasClass('other-option')) {
                                var val = parent.find('.form-elements .field-options .sortable-options li:nth-child('+(index + 1)+') input.option-owcpvValue').val(),
                                    label = parent.find('.form-elements .field-options .sortable-options li:nth-child('+(index + 1)+') input.option-label').val();
                                //console.log(val);
                                e(f).addClass('type-'+subtype);
                                if(subtype == 'image-option' || subtype == 'image-extra') {
                                    if(val == '') val = opalwoocu.default_image;
                                    e(this).after('<label class="label-image-option" for="'+e(this).attr('id')+'"><img src="'+val+'" width="70" height="70"/></label>');
                                }
                                if(subtype == 'color-option') {
                                    if(val == '') val = '#3c434a';
                                    e(this).after('<label class="label-color-option" for="'+e(this).attr('id')+'" style="background-color:'+val+'"></label>');
                                }
                                // if(subtype == 'button-option') {
                                //     e(this).after('<label class="label-button-option" for="'+e(this).attr('id')+'">'+label+'</label>');
                                // }
                            }
                        })
                    }
                ...
                openField(t, r = !0) {
                    document.dispatchEvent(new CustomEvent("owcpvEditOpened", {
                        detail: { rowWrapperID: t }
                    }));
                ...
                removeField(t, r = 250) {
                    ...
                    if (!l.length) return m.a.opts.notify.warning(owcpv_trans_lib.noFieldsToRemove), !1;
                    const a = t && document.getElementById(t);
                    if (!t || !a) {
                        const e = [].slice.call(l).map((e) => e.id);
                        m.a.opts.notify.warning(owcpv_trans_lib.fieldIdRequiredFields),
                            m.a.opts.notify.warning(owcpv_trans_lib.removeLastField),
                            m.a.opts.notify.warning(owcpv_trans_lib.availableIDS + e.join(", ")),
                            (t = i.lastChild.id);
                    }
                    const s = e(a),
                        d = s.closest(this.formBuilder.rowWrapperClassSelector);
                    if (!a) return m.a.opts.notify.warning(owcpv_trans_lib.fileNotFound), !1;
                    s.slideUp(r, function () {

                        document.dispatchEvent(new CustomEvent("owcpvRowRemoved", {
                            detail: { field: s.find('.fld-name.form-control').val() }
                        }));
                        // e(document).trigger("owcpvRowRemove", [{ rowWrapperID: s.find('.fld-name.form-control').val() }]);
                ...
                editorUI(e) {
                    ...
                    (t.editorWrap = Object(p.t)("div", null, { id: r.formID + "-form-wrap", className: "form-wrap form-builder " + Object(p.u)() })),
                        ...
                        (t.controls = Object(p.t)("div", null, { id: o + "-control-box", className: "frmb-control" }));
            ...
            class v {
                ...
                setupControls() {
                    ...
                    for (let e = 0; e < t.length; e++) {
                        ...
                        var fieldName = r.replace(/-[\d]{4}$/, ""),
                            classC = 'other-field';

                        if(jQuery.inArray(fieldName, ['select', 'checkbox-group', 'radio-group']) !== -1) {
                            classC = 'group-field';
                            if (typeof n.checkboxsubtype != undefined && n.checkboxsubtype == 'single-checkbox') {
                                classC = 'special-field';
                            }
                        }
                        if(jQuery.inArray(fieldName, ['file']) !== -1) {
                            classC = 'special-field';
                        }
                        if(jQuery.inArray(fieldName, ['date']) !== -1) {
                            classC = 'date-field';
                        }
                        if(jQuery.inArray(fieldName, ['text', 'number', 'textarea']) !== -1) {
                            if (n.type == 'text' && n.subtype == 'color') {
                                classC = 'special-field';
                            }
                            else {
                                classC = 'input-field';
                        ...
                        const s = Object(p.t)("li", Object(p.t)("span", l), { className: `${a} ${classC} input-control input-control-${e}` });
                ...
                appendControls() {
                    const e = document.createDocumentFragment(),
                        inputControl = document.createElement('ul'),
                        groupControl = document.createElement('ul'),
                        dateControl = document.createElement('ul'),
                        specialControl = document.createElement('ul'),
                        otherControl = document.createElement('ul');

                    Object(l.b)(this.dom),
                        this.orderFields(this.controlList).forEach((t) => {
                            const r = this.allControls[t];

                            if (jQuery(this.allControls[t]).hasClass('input-field')) {
                                inputControl.appendChild(r);
                            }
                            else if (jQuery(this.allControls[t]).hasClass('group-field')) {
                                groupControl.appendChild(r);
                            }
                            else if (jQuery(this.allControls[t]).hasClass('date-field')) {
                                dateControl.appendChild(r);
                            }
                            else if (jQuery(this.allControls[t]).hasClass('special-field')) {
                                specialControl.appendChild(r);
                            }
                            else if (jQuery(this.allControls[t]).hasClass('other-field')) {
                                otherControl.appendChild(r);
                            }
                            else {
                                r && e.appendChild(r);
                            }
                        ...
                        e.appendChild(inputControl);
                        e.appendChild(groupControl);
                        e.appendChild(dateControl);
                        e.appendChild(specialControl);
                        e.appendChild(otherControl);
                        this.dom.appendChild(e);

                    // r(e.target).closest(".form-field").trigger('owcpv_added_option');
                }
            }
            function x(e, t) {
                if (null == e) return {};
            ...
            function I(e, t, r) {
                ...
                const I = new v(e, b),
                    ...
                    P = r(b.stage),
                    M = r(b.controls).children('ul');
                    // console.log(M.hasClass('tesst'));
                let H,
                    z,
                    W = !1,
                    U = !1,
                ...
                const Z = (t, o = !1) => {
                    ...
                    if ((i && (n.style = i[1]), o)) {
                        const e = setTimeout(() => {
                            ...
                            n['wrapid'] = d.lastID;
                            document.dispatchEvent(new CustomEvent("owcpvFieldAdded", {
                                detail: { field: n }
                            }));
                        }, 10);
                    }
                        ...
                        l = {
                            ...
                            options: () =>
                                (function (e) {
                                    ...
                                    if (kh.checkboxsubtype) {
                                        st = kh.checkboxsubtype;
                                    }
                                    ...
                                    const n = [C("a", c.a.get("addOption"), { className: "add add-opt" })],
                                        ...
                                        a = (e) => {
                                            let t = c.a.get("optionCount", e);
                                            if (st == 'single-checkbox') t = 'True';
                                    ...
                                    const s = C("div", n, { className: "option-actions" }),
                                        d = C(
                                            "ol",
                                            o.map((e, r) => {
                                                const o = m.a.opts.onAddOption(e, { type: t, index: r, isMultiple: l }, st);
                                                return Ae(o, l);
                                            }),
                                            { className: "sortable-options" }
                                        ),
                                        u = C("div", [d, s], { className: "sortable-options-wrap" });
                                    return i.push(u), C("div", i, { className: "form-group general field-options" }).outerHTML;
                                })(t),
                ...
                function oe(e, t) {
                    ...
                    var name_i = (t.name) ? t.name : e;
                    let l = { id: e + "-" + d.lastID, title: i.description || i.label || e.toUpperCase(), name: name_i, type: i.type || "text", className: ["fld-" + e, (r || o || "").trim()], value: i.value || "" };
                    ...
                    return `<div class="form-group ${l.group} ${e}-wrap">${a}${`<div class="input-wrap">${(() => {
                        if ("textarea" === l.type) {
                            const e = l.value;
                ...
                function ne(e, t) {
                    const { multiple: r, options: o, label: i, value: l, class: a, className: s } = t,
                        u = x(t, ["multiple", "options", "label", "value", "class", "className", 'description']),
                        f = Object.keys(o).map((e) => {
                            const r = (o[e].label) ? o[e].label : o[e],
                        ...
                        p = { id: `${e}-${d.lastID}`, title: u.description || i || e.toUpperCase(), description: t.description || '', name: e, className: `fld-${e} form-control ${a || s || ""}`.trim() };
                        r && (p.multiple = !0);
                    ...
                    var gr = (t.group) ? t.group : 'general';
                    return `<div class="form-group ${gr} ${e}-wrap">${m}${`<div class="input-wrap">${C("select", f, p).outerHTML}</div>`}</div>`;
                }
                const ie = (e, t, r = {}) => {
                        const o = (t) => C("label", t, { for: `${e}-${d.lastID}` }).outerHTML,
                            n = { type: "checkbox", description: t.description || '', className: "form-control fld-" + e, name: e, id: `${e}-${d.lastID}` };
                        t[e] && (n.checked = !0);
                        const i = [];
                        let l = [C("input", null, n).outerHTML, C("span", null, '').outerHTML];
                        // let kh = [C("span", null, '').outerHTML];
                        ...
                        return (
                            ...
                            (l = C("label", l, { className: "input-wrap kc-toggle" }).outerHTML),
                            C("div", i.concat(l), { className: `form-group ${gr} ${e}-wrap` }).outerHTML
                        );
                    },
                    le = (e) => {
                        let t = "";
                    ...
                    ae = (e, t) => {
                        const { class: r, className: o, value: n } = t,
                            ...
                            l = c.a.get(e) || e,
                            a = { type: "number", value: i, description: t.description || '', name: e, placeholder: c.a.get("placeholder." + e), className: `fld-${e} form-control ${r || o || ""}`.trim(), id: `${e}-${d.lastID}` },
                            s = A.input(Object(p.D)(a)).outerHTML;
                        var gr = (t.group) ? t.group : 'general';
                        return C("div", [`<label for="${a.id}">${l}</label>`, `<div class="input-wrap">${s}</div>`], { className: `form-group ${gr} ${e}-wrap` }).outerHTML;
                    },
                    se = (e, t, r) => {
                        ...
                        var gr = (t.group) ? t.group : 'general';
                        return C("div", [a, u], { className: `form-group ${gr} ${i.name}-wrap` }).outerHTML;
                    },
                    de = (t, r, o = !1) => {
                        const n = ["paragraph"];
                        let i = r[t] || "",
                        ...
                        if (![].some((e) => !0 === e)) {
                            ...
                            let f = o ? "none" : "block";
                            "value" === t && (f = r.subtype && "quill" === r.subtype && "none"), (s = C("div", [c, u], { className: `form-group ${gr} ${t}-wrap`, style: "display: " + f }));
                        }
                        return s.outerHTML;
                    },
                    ce = (e) => {
                ...
                P.on("change", [".prev-holder input", ".prev-holder select", ".prev-holder textarea"].join(", "), (e) => {
                    ...
                    P.on("click touchstart", `.${w.a}copy`, function (t) {
                        ...
                        !(function (e, t) {
                            ...
                            document.dispatchEvent(new CustomEvent("owcpvFieldCopy", {
                                detail: { field: d.lastID }
                            }));
                    }),
                ...
                function Be(e = !0) {
                    if (e)
                        (je = !0),
                            A.showToast(owcpv_trans_lib.startGridMode, 1500),
                            M.css("display", "none"),
                        ...
                        A.showToast(owcpv_trans_lib.gridModeFinished, 1500);
                ...
                if (
                    ...
                    P.bind("mousewheel", function (e) {
                        if (je) {
                            ...
                            if (
                                ...
                                return void A.showToast('<b class="formbuilder-required">'+owcpv_trans_lib.maximumColumns+'</b>');
                    ...
                    P.on("click", ".add-opt", function (e) {
                        ...
                        const t = r(e.target).closest(".form-field").attr("type"),
                            ...
                            n = r('[name="multiple"]', o),
                            st = r(e.target).closest(".form-field").find('select[name="radiosubtype"]'),
                        ...
                        const a = r(".sortable-options", o),
                            s = m.a.opts.onAddOption({ selected: !1, label: "", value: "" }, { type: t, index: a.children().length, isMultiple: l }, subtype);
                        a.append(Ae(s, l));
                ...
                return (
                    document.dispatchEvent(new CustomEvent("owcpvLoaded", {
                        detail: { data: A.getFormData() }
                    })),
                                ...
                                c.a
                                    ...
                                    .then(() => {
                                        t.each((e) => {
                                            ...
                                            e(F.instance);
                                        jQuery(document).trigger('owcpv_on_init_formbuilder_editor');
                                    })
                                    .catch((e) => {
